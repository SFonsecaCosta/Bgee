...
For this course, you will need R.4.0, which you can download from https://cran.r-project.org/ (if you are using RStudio cloud, that is recommended for this course, this is not necessary) and Bioconductor software version 3.11.
...
In more detail: the steps Extract information, Download data and Processing data we will use DM data.
