...
You can also agroup the data per correspondent anatomical entities. Note that here a violin_plot can represent multiple samples if the libraries in same experiment belongs to same the anatomical entity.
...
From this experiment we can rescue samples from the same anatomic entity and same developmental stage. Now we will search which samples from this experiment differ by sex.
