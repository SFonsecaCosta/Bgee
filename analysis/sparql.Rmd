...
You can retrieve data by specifying your target species and the target developmental stage by retrieving all anatomical entities. Here, we will use the example of *Bos taurus* (cattle) with the developmental stage 'prime adult stage'.
