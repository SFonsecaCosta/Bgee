...
In order to retrieve the annotation about the species and the data type of interest you have to create a Bgee object. You are able to provide in the `species` argument the name of the species or the NCBI taxonomic IDs.

For this course we will use the Drosophila melanogaster data and the last release of Bgee (14.1).
...
From the informative files (in this case: Drosophila_melanogaster_RNA-Seq_experiments.tsv or Drosophila_melanogaster_RNA-Seq_libraries.tsv) you are able to target experiments or libraries of interest before you start downloading the data.

Suggestion: Try to extract an experiment that have a minimum amount of 10 libraries and maximum of 25 libraries in Drosophila melanogaster informative file. 
During the filtering process allow the experiment to have samples in different condictions and samples in different stages.
